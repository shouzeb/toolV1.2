...
def preditWithPATFingerprint(BPS_list,name,currentdate):
...
def testingWithFingerprint(PAT_list,video_name,currentdate):
...
# =============================================================================
    ...
    with open(r"E:\ads\toolV1.2\mysite\models\DF PAT\Detailed_Results_PAT_"+currentdate+'.csv', 'a') as f_object:        
